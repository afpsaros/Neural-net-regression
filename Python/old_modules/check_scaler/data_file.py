...
class data_getter:
    ...
    def preproc(self, normalize):
        ...
        if self.normalize == 1:
            ...
            self.Xt_norm = self.scaler.fit_transform(self.Xt)
            self.Yt_norm = self.scaler.fit_transform(self.Yt)
            self.Xv_norm = self.scaler.fit_transform(self.Xv)
            self.Yv_norm = self.scaler.fit_transform(self.Yv)
            self.Xe_norm = self.scaler.fit_transform(self.Xe)
            self.Ye_norm = self.scaler.fit_transform(self.Ye)
